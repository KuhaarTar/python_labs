...
def registerer(input_func):
    method_name = input_func.__name__

    def register_to_file():
        reg_file = open("register_method", "a")
        reg_file.write(method_name)
